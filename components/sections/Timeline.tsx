                  ...
                  <div className="grid grid-cols-1 md:grid-cols-[200px_1fr] lg:grid-cols-[280px_1fr] gap-6 md:gap-12">
                    ...
                    <div>
                      <div className="flex items-baseline gap-4 mb-4">
                        <span className="font-mono text-[12px] text-th-text3 tracking-[0.1em]">{num}</span>
                        <span className="font-mono text-[12px] text-th-text3 tracking-[0.1em]">{role.period}</span>
                      </div>
                      <p className="font-display text-[14px] font-bold text-th-text tracking-[0.12em]">
                        {role.role}
                      </p>
                    </div>
