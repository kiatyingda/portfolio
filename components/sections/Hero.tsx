...
import DesktopChat from '@/components/ui/DesktopChat'
        ...
        <div className="max-w-[1136px] mx-auto w-full px-8 md:px-12 pt-28 pb-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div>
              ...
              <h1
                className="font-display font-bold text-[44px] sm:text-[56px] md:text-[72px] leading-[1.08] text-th-text mb-6 md:mb-8 hero-enter hero-enter-2"
            ...
            {/* Desktop chat mockup */}
            <div className="hidden lg:flex justify-center items-center hero-enter hero-enter-4">
              <DesktopChat />
            </div>
          </div>
        </div>
