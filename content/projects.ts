    ...
    caseStudy: {
      ...
      sections: [
        ...
        },
        {
          ...
          label: 'Boost Web · v1',
          caption: 'The first version — established the information hierarchy for every campaign type that followed.',
        },
        {
          type: 'image',
          bg: 'light',
          gap: 'tight',
          image: '/images/okx-boost-leaderboard.png',
          label: 'Boost Leaderboard',
          caption: 'Discovery surface for Boost tokens and ongoing DEX competitions — legibility over data-dump.',
        },
        {
          type: 'image',
          bg: 'light',
          ...
          caption: 'X Launch · X Campaign · X Stake — one modular system handling different mechanics, intents, and information needs.',
        },
        {
          type: 'outcome',
          bg: 'dark',
