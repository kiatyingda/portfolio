...
export const projects: Project[] = [
  ...
  // ── 2. OKX Boost ─────────────────────────────────────────────────────────
  {
    ...
    summary: 'Staking, boosts, multipliers — inherently complex financial mechanics that most competitors bury in information overload. I designed a growth product that made them feel simple.',
      ...
      sections: [
        {
          ...
          imageHint: 'OKX Boost product hero — staking dashboard with multiplier UI — okx-boost-hero.png',
        },
        {
          type: 'columns',
          bg: 'dark',
  ...
  // ── 3. SingHealth ─────────────────────────────────────────────────────────
  {
    ...
    summary: 'Nurses were drowning in paperwork. I redesigned the patient-facing app to reduce friction at every clinical touchpoint — serving 3,000 patients daily across Singapore\'s largest healthcare cluster.',
      ...
      sections: [
        ...
        },
        {
          ...
          columns: [
            {
              heading: 'My Care',
              body: 'A summary of medical information at a glance — vitals, test results, medications, and dietary restrictions.',
            },
            {
              heading: 'My Request',
              body: 'Patients can request water, tea, blankets, or call a nurse — directly from the bedside iPad.',
            },
            {
              heading: 'My Schedule',
              body: 'Daily schedule showing meals, medications, visiting hours, and upcoming procedures.',
            },
          ],
        },
        {
        ...
        },
        {
          ...
          bg: 'dark',
          label: 'Key screens',
          heading: 'Designed for bedside use.',
          left: {
            heading: 'My Request',
            body: 'Simple icon-based grid for common requests — water, tea, biscuit, clean room, newspaper, blanket, and call nurse. Pending requests shown at top.',
          },
          right: {
            heading: 'Food tracking',
            body: 'Visual food logging with illustrated plates — patients slide to indicate how much they ate. Data flows directly to the nursing dashboard.',
          },
        ...
        },
        {
          ...
          reflections: [
            {
              title: 'Design for the most vulnerable',
              body: 'Elderly patients, post-surgery patients, caregivers of children — each had different needs. The visual food tracking was the breakthrough that nurses loved most.',
            },
            {
              title: 'Reduce, don\'t replace',
              body: 'MyCare didn\'t replace nurses — it freed them to focus on care instead of paperwork.',
            },
          ],
        },
      ],
